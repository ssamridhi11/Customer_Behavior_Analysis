...
--Compares the average Purchase Amounts between Standard and Express Shipping. 
...
--Segments customers into New, Returning, and Loyal based on their total 
...
--Gets top 3 most purchased products within each category
WITH item_counts AS (
    SELECT category,
           item_purchased,
